...
### Kenmerken
**Veranderen**
Door met meerdere teams de devOps reis te hebben ervaren kan ik nieuwe teams bijstaan in een DevOps werkwijze.
...
### Ervaring
#### Omgeving
Enterprise, Financiele Dienstverlening (Achmea, Rabobank) en logistieke bedrijven (Nederlandse Spoorwegen,ProRail, DHL). Ook bij Kamer van Koophandel, Iddink, Movares en een groot aantal projecten bij diverse andere bedrijven.
...
- Middleware, Java applicatieservers
- Linux (RedHat, Debian)
